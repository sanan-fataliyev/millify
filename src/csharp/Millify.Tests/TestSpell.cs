...
namespace Millify.Tests
{
    ...
    public class TestSpell
    {
        ...
        {
            Assert.Equal(expected, Milli.AsOrdinal(number));
        }
        ...
        {
            Assert.Equal(expected, Milli.SpellAsOrdinal(number));
        }
        ...
        {
            Assert.Equal(expected, Milli.AsCurrency(number));   
        }
        ...
        {
            Assert.Equal(expected, Milli.SpellAsCurrency(number));   
        }
        ...
        {
            Assert.Equal(expected, Milli.AsCurrency(number, nominalName:"dollar", coinName:"cent"));   
        }
